...
int main(int argc, char **argv)
{
	...
	*/
    ...
    if(argc<2) 
	{
        printf("Usage: llat test-time-in-seconds loop-dealy-time-in-us cpu-affinity-bit-mask\n");
    ...
    if(argc<4) 
	{
		params.ul_cpus = 3;  // Different CPU binding from DPD simulation applications.
        //exit(0);
    }
	else
	{
